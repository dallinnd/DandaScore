...
function toggleMenu() {
    ...
    menu.innerHTML = `
        <div class="menu-panel flex flex-col">
            ...
            <div class="mb-10">
                <p class="text-[10px] font-black uppercase tracking-widest opacity-50 mb-4">Appearance</p>
                <div class="flex flex-col gap-3">
                    <button onclick="setTheme('dark')" class="w-full text-left p-4 rounded-2xl border-2 ${settings.theme === 'dark' ? 'border-green-600 bg-green-600/10' : 'border-black/5 bg-black/5'}">
                        <div class="font-black">Navy Dark</div>
                    </button>
                    <button onclick="setTheme('light')" class="w-full text-left p-4 rounded-2xl border-2 ${settings.theme === 'light' ? 'border-blue-600 bg-blue-600/10' : 'border-black/5 bg-black/5'}">
            ...
            <div class="mt-auto">
                <button onclick="clearHistory()" class="w-full text-red-600 font-bold p-4 opacity-70 text-sm italic">Clear All History</button>
            </div>
        </div>
    `;
